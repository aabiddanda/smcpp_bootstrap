...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--nr_bootstraps", type=int, help="nr of bootstraps [10]", default=10
    )
    parser.add_argument(
        "--chunk_size",
        type=int,
        help="size of bootstrap chunks [10000000]",
        default=10000000,
    )
    parser.add_argument(
        "--chunks_per_chromosome",
        type=int,
        help="nr of chunks to put on one chromosome in the bootstrap [13]",
        default=13,
    )
    parser.add_argument(
        "--nr_chromosomes", type=int, help="nr of chromosomes to write [22]", default=22
    )
    parser.add_argument(
        "--seed", type=int, help="initialize the random number generator", default=None
    )
    parser.add_argument(
        "--out_dir_prefix", required=True, help="prefix for the outdirectory"
    )
